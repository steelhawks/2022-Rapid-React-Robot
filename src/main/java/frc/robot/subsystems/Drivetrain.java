...
public class Drivetrain extends MechanicalSubsystem{
  ...
  // final WPI_TalonSRX LEFT_MOTOR_THREE;
  ...
  public Drivetrain() 
  {
    ...
    //SPEED CONTROLLER GROUPS
    this.RIGHT_M_GROUP = new MotorControllerGroup(this.RIGHT_MOTOR_ONE, this.RIGHT_MOTOR_TWO);
    this.LEFT_M_GROUP = new MotorControllerGroup(this.LEFT_MOTOR_ONE, this.LEFT_MOTOR_TWO);
  ...
  //       LEFT_M_GROUP.set(-0.3);
  //       RIGHT_M_GROUP.set(-0.3);
  //     }
